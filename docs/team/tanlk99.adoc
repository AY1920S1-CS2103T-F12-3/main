...
** Tools:
*** Integrated ControlsFX to the project for the autocomplete feature (https://github.com[#42])
...
|===
|_Given below is the section I contributed to the User Guide. They showcase my ability to write documentation targeting end-users._
|===
...
|===
|_Given below is a sample of my contribution to the Developer Guide. They showcase my ability to write technical documentation and the technical depth of my contributions to the project._
|===

include::../DeveloperGuide.adoc[tag=userprompting]
