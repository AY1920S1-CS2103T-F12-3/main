...
* *Code contributed*: The following links highlight samples of my code [https://github.com[Functional code]] [https://github.com[Test code]] _{give links to collated code files}_

* *Other contributions*:

** Documentation:
*** Updated the developer guide to better reflect `Model` and `Storage` components after they have been changed to accommodate other features: https://ay1920s1-cs2103t-f12-3.github.io/main/DeveloperGuide.html#Design-NoteModel[NoteModel], https://ay1920s1-cs2103t-f12-3.github.io/main/DeveloperGuide.html#Design-Storage[StorageComponent] https://github.com[#14]
** Community:
*** Contributed to forum discussions to clarify potential tripups (examples:  https://github.com/nus-cs2103-AY1920S1/forum/issues/131[131], https://github.com[1], https://github.com[2], https://github.com[3], https://github.com[4])
*** Reviewed and offered suggestions for other teams in class  (examples:  https://github.com[1], https://github.com[2], https://github.com[3])
