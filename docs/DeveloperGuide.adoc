...
image::FilterKeywordSequenceDiagram.png[]
...
**Step 1:** The user command is passed through the `LogicManager` and a `ListNoteCommand` with the `Filter` containing the keywords and `FilterType.TAG` is returned.
