...
image::UserPromptSequenceDiagramStep1.png[width=790]
...
image::UserPromptSequenceDiagramStep2.png[width=790]
...
image::UserPromptSequenceDiagramStep3.png[width=790]

The full sequence diagram is shown below:

image::UserPromptSequenceDiagramFull.png[width=790]
