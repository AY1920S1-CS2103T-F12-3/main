...
When you enter a command, TagLine will display auto-complete suggestions as you type.
...
.. After step 1 of the above example, let's say you no longer want to create a new command. Press the Escape key.
+
...
When given prompts, to minimize inconvenience to you, the autocomplete menu is temporarily disabled. Once prompting is complete, autocomplete will be re-enabled.
====
